...
export default function TabBarWishlistIcon({ color, size = 22 }: TabBarIconProps) {
  // Original viewBox: "0 0 24 22"
  // Size adjusted slightly based on viewBox aspect ratio if size prop is used
  ...
  return (
    <Svg width={width} height={height} viewBox="0 0 24 22" fill="none">
      <Path
        ...
        strokeWidth="2" // Stroke width from original
      />
    </Svg>
  );
}